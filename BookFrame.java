...
import java.sql.*;            //for sql and jdbc
...
public class BookFrame {
    ...
    void getConnectionFromMySQL() {
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db1", "root", "Mysirg20232001");
    ...
    class InsertBookRecord implements ActionListener{               //event handler
        @Override
